...
# Express + Webpack 4 + Bootstrap 4 + Handlebars

Express site built with Webpack, Bootstrap and Handlebars.
...
```
git clone https://github.com/grancier/webpack-boiler.git  your-app-name
cd your-app-name
yarn install
```
